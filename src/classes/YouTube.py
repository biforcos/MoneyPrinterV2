        ...
        for _ in range(3):
            title = self._clean_metadata_text(
                self.generate_response(
                    ...
                    f"{search_hint}"
                    "Use ONLY people, companies and proper nouns that appear in the "
                    "subject — NEVER add a famous name the subject does not mention "
                    "(e.g. if it says 'its actor', do NOT guess who that is). "
